    ...
    <div className="max-w-[1920px]">
      ...
      <div className="container mx-auto mt-12 flex md:flex-row px-12 items-center justify-center flex-col w-full max-w-[1220px]">
        ...
        <div className="ml-12 md:w-[526px] w-full space-y-4  mt-8 left-{1094px} top-{714px} flex flex-wrap ">
          <h1 className="text-sm font-medium text-yellow-500 italic">
            About us _____
          </h1>
          ...
          <div className="flex justify-center">
            <Link href="/shop">
              <button className="inline-flex text-white bg-yellow-500 border-0 py-2 px-3 focus:outline-none rounded text-lg">
                Show More
              </button>
            </Link>
