  ...
  return (
    ...
    <div className=" px-4 sm:px-8 lg:px-16 py-12">
      <div className="text-left mb-12 ml-4 sm:ml-8 lg:ml-12">
        <p className="font-greatvibes text-[24px] sm:text-[32px] text-yellow-500">
          Testimonials
        </p>
        <h2 className="font-bold text-3xl sm:text-4xl lg:text-5xl text-[#333333]">
      ...
      <div className="flex flex-col items-center text-center pb-8">
        ...
        <div className="max-w-4xl mx-auto  bg-[#ffffff] p-8 rounded-lg shadow-lg">
          <PiQuotesLight
            size={47}
            className="text-yellow-500 mt-10 mx-auto mb-4"
          />
