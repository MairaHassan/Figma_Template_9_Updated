...
const Ourshop = () => {
  return (
    <>
      ...
      <div className="container mt-20 mb-16 flex flex-col md:flex-row gap-8  mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 mt-6">
            {data.map((item) => (
              ...
              >
                ...
                <Link href={`/products/${item.id}`}>
                  <button className="mt-2 w-full bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">
                    Show Details
                  </button>
                </Link>
              </div>
        ...
        <div className="w-[312px] md:h-[418px]">
          <div className="flex w-[248px] h-[46px] mt-[72px] text-center ">
            ...
            <CiSearch
              size={20}
              className="bg-orange-400 p-3 text-[#FFFFFF] w-[46px] h-[46px]"
            />
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex w-[63px] gap-1 mb-1 h-[9px]">
                  <FaStar size={10} className="text-[#FF9F0D] " />
                  <FaStar size={10} className="text-[#FF9F0D] " />
                  <CiStar size={10} className="opacity-15" />
                  <CiStar size={10} className="opacity-15" />
                  <CiStar size={10} className="opacity-15" />
                </div>
                <p className="text-black">14.5$</p>
