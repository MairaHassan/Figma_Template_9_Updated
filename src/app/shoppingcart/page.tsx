...
const Page = () => {
  ...
  const productImages = [
    "/images/me1.png", // Assuming the uploaded image is used here
    "/images/me2.png",
    "/images/pizza.png",
    "/images/me4.png",
    "/images/prawn.png",
          ...
          <div className="flex flex-col md:flex-row justify-center">
            <div className="w-full rounded-md">
              ...
              {products.map((item, index) => (
                <div
                  key={index}
                  className="grid grid-cols-5 ml-20  gap-4 items-center border-b py-4"
                >
                  <div className="flex flex-col md:flex-row items-center md:w-[225px] h-auto w-full gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-1">
                        ...
                        <FaStar size={12} className="text-yellow-500" />
                        <FaStar size={12} className="text-yellow-500" />
                        <FaStar size={12} className="opacity-15" />
                        <FaStar size={12} className="opacity-15" />
                      </div>
                    </div>
                  </div>
                  <div className="text-gray-800 md:block hidden font-bold ml-16 w-[58px]">
                    ${prices[index]}
                  </div>
                  <div className="md:flex hidden items-center">
                    <button className="flex w-[94px] pl-12 items-center gap-2 border rounded-full px-4 py-1">
                      <span>1</span>
                      <span className="text-yellow-500">+</span>
                    </button>
                  </div>
                  <div className="text-gray-800 md:block hidden w-[70px] font-bold">
                    ${total[index]}
                  </div>
                  <div>
            ...
            <div className="flex flex-col md:max-w-[1320px] mb-8 h-auto w-full md:flex-row md:gap-6">
              <div className=" md:max-w-[424px] px-2 w-full ">
                ...
                <div className="border p-2 rounded-md">
                  ...
                  <div className="flex flex-col sm:flex-row">
                    ...
                    />
                    <button className="bg-yellow-500 text-white md:text-[18px] text-sm px-6 py-2 rounded-md">
                      Apply
                    </button>
                  </div>
                </div>
              ...
              <div className="  mx-2 md:w-[648px] h-auto w-full ">
                ...
                <div className="border p-4 rounded-md">
                  ...
                  <Link href="/checkout">
                    {" "}
                    <button className="w-full bg-yellow-500 text-sm md:text-[18px] text-white py-3 rounded-md font-semibold">
                      Proceed to Checkout
                    </button>
                  </Link>
                </div>
