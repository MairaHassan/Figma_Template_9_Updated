  ...
  return (
    ...
    {/* first div */}
      ...
      <div className="md:max-w-[871px] h-[520px] bg-[url(/images/ab1.png)] bg-cover bg-center">
        <button className="w-[60px] h-[60px] bg-[#FF9F0D] text-[#ffffff] font-bold rounded-[6px] ml-[20px] mt-[20px]">14 Feb
          {/* Add button content if needed */}
        </button>
      </div>

      <p className="flex gap-2 my-6">
        <PiCalendar size={24} className="text-[#FF9F0D]" />
      ...
      <h2 className="font-bold text-[24px] mb-6">
        10 Reasons To Do A Digital Detox Challenge
      </h2>
      <p className="text-[16px] md:max-w-[678px] text-justify">
        At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd
        gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem
        ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
        eirmod tempor invidunt ut labore et dolore magna aliquyam erat
      </p>
      <button className="w-[172px] h-[52px] text-[#FF9F0D] border-[#FF9F0D] border-[1px] my-8 px-8">
        Read More
      </button>

      {/* second div */}

      <div className="md:max-w-[871px] h-[520px] bg-[url(/images/blog2.png)] bg-cover bg-center">
        <button className="w-[60px] h-[60px] bg-[#FF9F0D] text-[#ffffff] font-bold rounded-[6px] ml-[20px] mt-[20px]">14 Feb
          {/* Add button content if needed */}
        </button>
      </div>
