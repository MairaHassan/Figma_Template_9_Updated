    ...
    <div className="md:max-w-[872px] ">
      <div>
        ...
        <div className="md:max-w-[872px] h-[832px] top-[530px] px-8 space-y-4 left-[300px]">
          <div
            className="bg-cover bg-center md:h-[520px] h-[300px] md:max-w-[872px] "
          ...
          <div className="md:max-w-[872px] h-fit flex gap-2 ">
            ...
            <span className="text-[16px] font-[400] font-inter">
              Feb 14, 2022
            </span>
            &#47;
            <TiMessages size={24} className="text-[#ff9f0d]" />
            <span className="text-[16px] font-[400] font-inter">3</span>&#47;
            <PiUserCirclePlus size={24} className="text-[#ff9f0d]" />
            <span className="text-[16px] font-[400] font-inter">Admin</span>
          </div>
          <h2 className="md:max-w-[860px] font-helvetica font-bold text-[24px]">
            10 Reasons To Do A Digital Detox Challenge
          </h2>
          <p className="md:max-w-[850px] md:h-[96px] text-justify h-fit text-[16px] font-[400] justify-normal mb-4 font-inter">
            ...
            suspendisse hac integer leo erat aliquam ut himenaeos. <br /> <br />
        ...
        <div className="md:max-w-[840px] mx-8 bg-[#FF9F0D] md:mt-8  mb-8 text-[#ffffff] h-[176px] top-[1431px] left-[300px]">
          <div className="flex gap-4 p-6 md:mt-[6rem] mt-[10rem]">
            <PiQuotes size={98} />
            <p className="font-helvetica font-bold text-[24px]">
        ...
        <div className="flex flex-col md:flex-row md:max-w-[872px] gap-6">
          ...
          <div className="md:w-1/2 w-full ">
            ...
            <span className="w-full p-4 block text-justify px-8">
              {" "}
              Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
              nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam
              erat, sed diam voluptua. At vero eos et accusam et justo duo
          ...
          <div className="md:w-1/2 w-full">
            <Image
              src="/images/prawn.png"
              alt="food"
              width={424}
              height={366}
              className="object-cover px-8 mt-8"
            />
          </div>
        </div>
        <p className="text-[#000000] font-[400] px-8 text-justify font-inter text-[16px] mt-8 mb-8">
          ...
          sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et
          dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam
          et justo duo dolores et ea rebum. <br /> <br />
          Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
          nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat,
          sed diam voluptua. At vero eos et accusam et justo duo dolores et ea
          rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem
        ...
        <div className="md:max-w-[872px] mb-16 px-8 flex flex-col md:flex-row justify-between p-4 border-[1px] ">
          <div className=" flex gap-4">
            <label htmlFor="tags" className="font-bold text-[16px]">
              Tags:{" "}
            </label>
          ...
          <div className=" flex gap-4">
            ...
            <p className="flex gap-3">
              <Link href="www.linkedin.com/in/maira-hassan-334259209/">
                <FaLinkedin size={20} />
              </Link>
              <Link href="https://github.com/MairaHassan">
        ...
        <div className="md:max-w-[872px]">
          ...
          <div className="md:max-w-[872px] px-8 h-fit">
            <h2 className="font-bold font-helvetica text-[32px]">
            ...
            {comments.map((comment) => (
              <div key={comment.id} className="flex mt-8 gap-6">
                <Image
                  ...
                  width={72}
                  height={65}
                  className="rounded-full w-[72px] h-[65px]"
                />
                <div className="space-y-2">
                  <div className="flex gap-2">
                    <h2 className="w-[126px] h-[24px] font-bold font-inter text-[16px]">
                      {comment.name}
                    </h2>
                  </div><br />
                  <p className="flex gap-2">
                    ...
                    /><br/>
                    <span className="opacity-30 font-[400] font-helvetica text-[14px] gap-5">
                      {comment.date}
                    </span>
                  </p>
                  <p className="font-[400] font-helvetica text-[16px]">
                    {comment.comment}
                  </p>
                </div>
              </div>
          ...
          <div className="md:max-w-[872px] px-8 space-y-8 my-8 h-fit">
            <h2 className="font-bold font-helvetica mt-8 text-[32px]">
              Post a comment
            </h2>
            <hr />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="bg-[#FF9F0D] w-[212px] h-[56]  text-white p-2 rounded font-bold"
              >
                Post a comment
              </button>
            </form>
